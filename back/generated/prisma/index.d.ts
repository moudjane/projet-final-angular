...
export namespace Prisma {
  ...
  export type PostOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<'id' | 'title' | 'url' | 'content' | 'authorId' | 'likes' | 'createdAt', ExtArgs['result']['post']>
